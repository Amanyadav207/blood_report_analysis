...
find_articles_task = Task(
    ...
    ''',
    expected_output='''
    A list of 3-5 carefully selected medical articles, each accompanied by a summary and an explanation of its relevance to the abnormal blood test results. The articles should be from credible sources and provide valuable insights related to the identified health concerns.
    ''',
...
provide_recommendations_task = Task(
    ...
    ''',
    expected_output='''
    A set of prioritized health recommendations, including a summary of the blood test findings, additional test suggestions, lifestyle advice, and relevant resources. The advice should be practical, actionable, and supported by credible sources.
    ''',
